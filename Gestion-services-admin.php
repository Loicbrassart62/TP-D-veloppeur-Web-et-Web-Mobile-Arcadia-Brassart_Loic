...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['create'])) {
        ...
        if ($result) {
            header('Location: Gestion-services-admin.php');
            exit();
        }
    ...
    <div id="wrap">
        ...
        <div class="container">
            <div class="services-container">
                ...
                <form action="Gestion-services-admin.php" method="POST">
        ...
        if (sizeof($result) > 0) {
            ...
            foreach ($result as $row) {
                echo "<tr>
                        <td>
                            <form action='Gestion-services-admin.php' method='post' style='display: inline;'>
